...
##############   for each flowcell                        ##########
####################################################################
my $merging= `~/tools/RefAligner -if ${bnx_dir}/flowcell_bnx.txt -o ${directory}/all_flowcells_adj_merged -merge -bnx -minsites 5 -minlen 100 -maxthreads 16`;
print "$merging";
####################################################################
...
####################################################################
my @err_files;
my $third_mqr_b = `~/tools/RefAligner -i ${directory}/all_flowcells_adj_merged.bnx -o ${directory}/all_flowcells_adj_merged_bestref -T ${T} -ref ${ref} -bnx -nosplit 2 -BestRef 1 -M 5 -biaswt 0 -Mfast 0 -FP 1.5 -FN 0.15 -sf 0.2 -sd 0.2 -A 5 -S -1000 -res 3.5 -resSD 0.7 -outlier 1e-4 -endoutlier 1e-4 -minlen 100 -minsites 5 -maxthreads 16`;
print "$third_mqr_b";
...
####################################################################
my $third_mqr = `~/tools/RefAligner -i ${directory}/all_flowcells_adj_merged.bnx -o ${directory}/all_flowcells_adj_merged -T ${T} -ref ${ref} -nosplit 2 -M 5 -biaswt 0 -Mfast 0 -FP 1.5 -FN 0.15 -sf 0.2 -sd 0.2 -A 5 -S -1000 -res 3.5 -resSD 0.7 -outlier 1e-4 -endoutlier 1e-4 -minlen 100 -minsites 5 -maxthreads 16`;
print "$third_mqr";
